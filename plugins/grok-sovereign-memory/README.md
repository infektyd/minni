...
This plugin contains **only**:
- The minimal SKILL overlay (TUI hybrid + hook participation + "V1 on top of canonical + ritual package")
- stdlib hook (`bin/grok-sovereign-hook.js` + `hooks/hooks.json`)
