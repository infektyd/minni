...
- **Library adapters (not MCP tools)**: `buildWorkerPacketAfterClaim` after assign → claim; `dispatchWorkerPacket` for host honesty. Do not register either as a tool.
