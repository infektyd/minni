...
requests, discussions) associated with the infektyd/minni repository, and
also applies when an individual is officially representing the project in
public spaces.

## Enforcement

There is no dedicated project email at this time. To report a Code of
Conduct violation:

- Open a [private security advisory](https://github.com/infektyd/minni/security/advisories/new)
  on the repository if the report is sensitive, or
- Contact [@infektyd](https://github.com/infektyd) directly via GitHub (a
  GitHub issue, or a DM if you're connected elsewhere).
