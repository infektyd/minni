...
| 08 | PR-7 | 3.4 | Query expansion (rule-based + AFM opt-in) | PR-4 (eval gate) | `[x]` |
| 09 | PR-8 | 3.5 | HyDE for cold queries | PR-4 (eval gate) | `[x]` |
...
| 15 | PR-14 | 6 PR-C | Reorganization + pruning passes | PR-13 | `[x]` |
