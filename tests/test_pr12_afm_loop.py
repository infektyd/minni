...
import minni.minnid_runtime.provenance as provenance  # type: ignore
from minni.principal import EffectivePrincipal  # type: ignore
...
def test_session_distillation_accepts_structured_native_compile_proposals(tmp_path, monkeypatch):
    from minni.afm_provider import AFMResult
    from minni.afm_passes.session_distillation import run
...
def test_scheduler_runs_most_overdue_pass_only_when_idle(tmp_path):
    from minni.afm_scheduler import AFMScheduler
    from minni.config import SovereignConfig
