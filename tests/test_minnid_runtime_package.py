...
def test_transport_helpers_live_in_runtime_package_and_remain_compat_exports():
    import minni.minnid as minnid
    from minni.minnid_runtime.transport import SOCKET_BODY_LIMIT, parse_request
...
def test_provenance_core_lives_in_runtime_package_and_remains_compat_exports():
    import minni.minnid as minnid
    from minni.minnid_runtime.provenance import (
...
def test_handoff_primitives_live_in_runtime_modules_and_remain_compat_exports():
    ...
    from minni.minnid_runtime.redaction import redact_text, redact_value
...
def test_operational_domains_live_in_runtime_modules_and_registry_delegates():
    ...
    from minni.minnid_runtime.ax import AXContext, handle_ax_snapshot_get, handle_ax_snapshot_store
    ...
    from minni.minnid_runtime.vault_index import (
