...
import minni.principal as principal  # type: ignore
from minni.principal import EffectivePrincipal, IdentityMismatchError
...
def test_can_read_document_denies_default_deny_principal_unknown_docs():
    ...
    from minni.principal import can_read_document, EffectivePrincipal as _EP
