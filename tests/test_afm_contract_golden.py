...
def _reset_generation_probe_cache():
    ...
    from minni.afm_provider import reset_afm_generation_probe_cache
...
def test_golden_afm_chat_completion_bridge_passes_payload_url_timeout_verbatim():
    from minni.afm_provider import DEFAULT_AFM_CHAT_COMPLETIONS_URL, afm_chat_completion
...
def test_golden_afm_chat_completion_bridge_honors_explicit_url():
    from minni.afm_provider import afm_chat_completion
...
def test_golden_invoke_native_afm_envelope_and_response_flattening(tmp_path, monkeypatch):
    from minni.afm_provider import invoke_native_afm
...
def test_golden_session_distillation_normalizer_rejects_bad_candidates():
    from minni.afm_passes.session_distillation import _normalize_native_draft
