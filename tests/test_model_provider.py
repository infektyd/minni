...
def _request(operation="prepare", **overrides):
    from minni.model_provider import ChatRequest
...
def test_retrieval_is_local_only_by_default(monkeypatch):
    from minni.model_provider import OperationPolicy, ProviderChain
...
def test_chain_returns_first_ok_result_and_stops():
    from minni.model_provider import ProviderChain
...
def test_afm_provider_off_mode_never_reaches_a_client():
    from minni.model_provider import AfmProvider
...
def test_failed_native_call_invalidates_cached_probe(monkeypatch):
    ...
    from minni.afm_provider import DEFAULT_AFM_CHAT_COMPLETIONS_URL, note_afm_generation_success
    from minni.model_provider import AfmProvider
...
def test_native_op_recoverable_trip_preserves_cached_probe(monkeypatch):
    ...
    import minni.afm_provider as afm_provider
    from minni.afm_provider import (
        AFMResult,
...
def test_native_op_success_marks_verified_only_with_content(tmp_path, monkeypatch):
    ...
    import minni.afm_provider as afm_provider
    from minni.afm_provider import DEFAULT_AFM_CHAT_COMPLETIONS_URL
    from minni.model_provider import AfmProvider
