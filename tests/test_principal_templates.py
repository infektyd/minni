...
def test_principal_templates_render_and_load_with_resolver(tmp_path: Path):
    ...
    from minni.tools.author_principals import AGENT_VAULT_DIRS, render_principal
...
def test_author_principals_dry_run_default_does_not_write(tmp_path: Path):
    from minni.tools.author_principals import AGENT_VAULT_DIRS, author_principals
