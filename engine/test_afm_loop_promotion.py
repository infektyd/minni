...
def test_loop_principal_is_daemon_internal_operator():
    from minnid_runtime.afm import loop_principal
...
def _loop_context(db_obj, cfg, *, ticks):
    ...
    from minnid_runtime import afm as afm_mod
    from minnid_runtime.provenance import guard_vault_root
...
def test_afm_loop_tick_promotes_safe_proposed_candidate(tmp_path, monkeypatch):
    ...
    from minnid_runtime.afm import afm_loop_runner
